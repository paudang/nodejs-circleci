...
describe('Memory Cache Client', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    jest.resetModules();
    MemoryCacheService = require('@/infrastructure/caching/memoryCache').default;
  });
  ...
  it('should handle errors in get', async () => {
    MemoryCacheService.cache.get.mockImplementation(() => {
  ...
  it('should handle errors in set', async () => {
    MemoryCacheService.cache.set.mockImplementation(() => {
      throw new Error('Cache Error');
    });
  ...
  it('should handle errors in del', async () => {
    MemoryCacheService.cache.del.mockImplementation(() => {
      throw new Error('Cache Error');
    });
