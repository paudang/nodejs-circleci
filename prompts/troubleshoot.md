...
3. **Dependencies & Resilience**:
   ...
   - If the error is due to an external service timeout or instability, consider recommending our built-in `CircuitBreaker, Timeout, Retry` utilities from `src/utils/resilience`.
4. **Fix Suggestion**:
